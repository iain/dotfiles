...
" General colors
hi Normal guifg=#f6f3e8 guibg=black ctermbg=0
...
hi Title guifg=#f6f3e8 gui=NONE ctermfg=187 cterm=NONE
...
hi ErrorMsg guifg=white guibg=#FF6C60 gui=NONE ctermfg=white ctermbg=203 cterm=NONE
hi WarningMsg guifg=white guibg=#FF6C60 gui=NONE ctermfg=white ctermbg=203 cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
 ...
 hi MatchParen guifg=#f6f3e8 guibg=#857b6f gui=NONE ctermfg=white
...
hi rubyInterpolationDelimiter guifg=#00A0A0 ctermfg=189
